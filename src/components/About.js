    ...
    <section id="about" className="section bg-gray-100 text-black dark:bg-[#23233a] dark:text-white">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h3 className="text-2xl md:text-3xl font-bold mb-6 bg-gradient-to-r from-indigo-400 via-purple-500 to-pink-500 text-transparent bg-clip-text">
          ...
          >
            <div className="rounded-2xl bg-white/5 border border-white/10 backdrop-blur-lg p-8 shadow-2xl">
              <h4 className="text-2xl font-bold mb-6 bg-gradient-to-r from-indigo-400 via-purple-500 to-pink-500 text-transparent bg-clip-text">Education</h4>
